        ...
        <div class="col-sm-12">
            <div class="card-body pt-0 mt-0">
                <table class="table table-hover my-0">
                    ...
                    <tbody>
                        @php
                            $birthdays = \Illuminate\Support\Facades\Cache::get('todays_birthdays', collect());
                        @endphp
                        @forelse ($birthdays as $index => $emp)
                            <tr>
                                ...
                                <td>{{ $emp['email'] }}</td>
                                <td>{{ \Carbon\Carbon::parse($emp['dob'])->format('d M') }}</td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="4" class="text-center">{{ __('No birthdays today') }}</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
