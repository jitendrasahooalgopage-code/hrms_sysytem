...
@section('header')
  <div class="d-flex align-items-center justify-content-between mb-4">
    ...
    @if($attendance_log->status === 'active')
      <form action="{{ route('admin.attendance.force-checkout', $attendance_log->id) }}" method="POST">
        @csrf
        @method('PATCH')
...
<div class="d-flex justify-content-end mt-4">
  <form action="{{ route('admin.attendance.destroy', $attendance_log->id) }}" method="POST">
    @csrf
    @method('DELETE')
